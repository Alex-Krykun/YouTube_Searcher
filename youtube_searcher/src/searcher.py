...
class YTSearcher():
    ...
    def _get_all_video_from_channel_id(self, channel_id: str) -> List[YTVideo]:
        ...
        try:
            ...
            while playlist_items:
                ...
                playlist_items = self.youtube_client.playlistItems().list_next(playlist_items, playlist_response)
    ...
    def get_all_videos_where(self, channel_name: str, search_pattern: str, fast_search=False) -> List[YTVideo]:
        ...
        for video in videos:
            ...
            try:
                ...
                logging.error(f"Error during getting video transcript {e=} {video.video_id=}")
